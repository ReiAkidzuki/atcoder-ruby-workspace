# AtCoder generative AI safety

Follow the current [AtCoder rules against generative AI](https://info.atcoder.jp/entry/llm-rules-en).
This repository intentionally uses a stricter fail-closed policy for general-purpose coding agents and does not implement the rules' translation exception.
